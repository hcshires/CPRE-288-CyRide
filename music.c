...
void load_songs() {
    ...
    /* CyRide Stop Requested */
    unsigned char cyrideNumNotes = 2;
    unsigned char cyrideNotes[2]    = {95, 79}; // G5 Tone from CyRide
    unsigned char cyrideDuration[2] = {16, 32};
    oi_loadSong(0, cyrideNumNotes, cyrideNotes, cyrideDuration);
